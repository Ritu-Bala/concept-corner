...
jQuery(document).ready(function($){
    ...
    var slug        = CMB2OptAdmin.posttype,
        cls         = {
            toggle:     'opt-content',
            tab:        'opt-tab',
        ...
        activetab   = '',
        page        = CMB2OptAdmin.page,
        $containers = $('.' + cls.toggle);


    console.log( CMB2OptAdmin );
    ...
    postboxes
        .add_postbox_toggles( cls.toggle );
    ...
    function tabSwitch( $tab ) {
        ...
        $( '.' + cls.tab )
            .removeClass( cls.wpactive );
        $( '#' + id )
            .addClass( cls.wpactive )
            .blur();
        ...
        $containers
            .each( function() {
                ...
                $.each( boxes, function(i,v) {
                    $( '#' + v )
                        .appendTo( $sortable )
                        .removeClass( 'hide-if-js ' + cls.hidden );
                });
            });
    }
