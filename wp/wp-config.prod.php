 ...
 * @package WordPress
 */
define('WP_REDIS_HOST', 'psocss-prod-redis.trauxb.ng.0001.usw2.cache.amazonaws.com');
...
define('DB_PASSWORD', 'Ipyx38Ak6IRtcyT');

/** MySQL hostname */
//define('DB_HOST', 'us-cdbr-azure-c-west-127-b.cloudapp.net');
define('DB_HOST', 'psocss-prod.cluster-cjhnb3whundc.us-west-2.rds.amazonaws.com');
